export default function DetailsPresdent() {
  return (
    <>
      <div className="relative z-10  gap-8 flex-col flex container  pt-24">
      <span className=" text-4xl font-bold text-center underline text-[#ff9825]">MOT DU PRÉSIDENT</span>
        <div className=" flex flex-col lg:flex-row gap-8 justify-center items-center lg:items-start      ">
            
          <div className="lg:w-1/4 w-2/3  flex gap-2 flex-col ">
            <img
            ...
            <div className=" lg:w-1/2 text-sm  whitespace-normal flex flex-col gap-4  dark:text-gray-400 leading-loose text-center lg:text-justify">
             <span>
             ...
             <span>
             Nous élargirons les horizons de l&apos;engagement international de notre université, au moyen de coopérations pertinentes et diversifiées, axées essentiellement sur la promotion de l&apos;innovation, la Recherche-Développement de pointe, ainsi que l&apos;accueil d&apos;étudiants internationaux en plus grand nombre, notamment ceux en provenance des pays de l&apos;Afrique subsaharienne, dans l&apos;esprit de l&apos;enracinement continental de notre pays et de son ouverture sur le monde.
             </span>
             <span>
             S&apos;appuyant sur une communauté universitaire engagée, à travers ses missions, et forte des valeurs de la responsabilité sociale, l&apos;Université Cadi Ayyad compte contribuer de manière tangible à la réalisation des objectifs du nouveau modèle de développement du pays. Avec le soutien de ses partenaires nationaux et internationaux, L&apos;UCA s&apos;engage à jouer pleinement son rôle de pionnier dans la construction d&apos;un Maroc fort, durable, et accueillant pour les générations futures.
             </span>
            <span>
            ...
            <span>
            Main dans la main pour une université sans frontières, l&apos;Université de demain !
            </span>
