            ...
            <div> 
              ...
              <div className={` relative rounded-b-lg   bg-[#FFFFFF] dark:bg-[#1c1f24] p-4 shadow-lg  ${openItem === ele.id ? 'block' : 'hidden'}`}>
                <div>
                    ...
                    <ul  className=" pb-4 ml-8 space-y-2 text-gray-500 list-disc list-inside md:text-base text-xs dark:text-gray-400">
                    {
                ...
                <ol className={`  ${!ele.equipes ?"hidden":"block"} `}>
                    ...
                    <li>
                    <ul  className="list-disc list-inside pb-4 ml-8 space-y-2 text-gray-500  md:text-base text-xs dark:text-gray-400">
                    {
