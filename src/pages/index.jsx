            ...
            <div className=" ">
                ...
                <div className=" container ">
                    <div className="flex flex-col items-center gap-4 py-8">
                        ...
                        InnovTech réunit 14 laboratoires et 5 équipes de recherche de 6 établissements de l&apos;UCA,
                ...
                <div className="py-24  relative">
                    ...
                    <div className=" absolute dark:bg-[#272b34] bg-[#f4f7fc] top-24 right-0 left-0 z-10  p-8"></div>
                        <span  className="lg:text-4xl container text-2xl text-[#3A9BE1]   font-bold absolute top-16 text-center z-20  right-0 left-0">Découvrez les 6 Établissements sur la Carte</span>
                </div>
            </div>
        </>
    )
